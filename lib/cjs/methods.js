...
exports.getToken = exports.getMethods = exports.makePaymentUrl = void 0;
...
const getMethods = ({ accessKey, secrectKey, sandbox }, lang) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const resp = yield (0, axios_1.default)(baseUrl, {
...
const getToken = ({ secrectKey, accessKey, sandbox }) => {
    const payload = {
        access_key: accessKey,
    };
    const token = jsonwebtoken_1.default.sign(payload, secrectKey, {
